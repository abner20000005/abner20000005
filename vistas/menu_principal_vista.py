"""
- Muestra el panel de navegación principal según el rol del usuario autenticado.
- Contiene botones para acceder a los módulos: Lectores, Libros, Préstamos, Devoluciones, etc.
"""
